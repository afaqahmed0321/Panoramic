          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12 text-gray-700 leading-relaxed">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-black uppercase tracking-widest border-l-4 border-mask pl-4">Information We Collect</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-black uppercase tracking-widest border-l-4 border-mask pl-4">How We Use Your Information</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-black uppercase tracking-widest border-l-4 border-mask pl-4">Data Protection</h2>
              ...
              <section className="space-y-4 bg-red-50 p-8 rounded-xl border border-red-200">
                <h2 className="text-2xl font-bold text-black uppercase tracking-widest border-l-4 border-red-600 pl-4">Guest Policy</h2>
                <p className="font-semibold text-gray-800">To comply with local laws and hotel regulations, non-married couples are not allowed at Panoramic Hotel. Valid identification and, where applicable, proof of marriage may be required at the time of check-in.</p>
              </section>
