            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="space-y-12">
                <div className="space-y-4">
                  ...
                  <p className="text-gray-600">Ask us anything. Our team is here to help you 24/7.</p>
                </div>
                ...
                <div className="space-y-8">
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">S-19 Shahrah e Quaid e Azam, Mall Road, Lahore, 54000</p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <a href="tel:+923218777749" className="text-gray-600 hover:text-black transition-colors">+92 321 8777749</a>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-6">
                    ...
                    <div>
                      ...
                      <a href="mailto:info@panoramichotel.co" className="text-gray-600 hover:text-black transition-colors">info@panoramichotel.co</a>
                    </div>
                  </div>
                </div>

                {/* Google Maps Embed */}
                <div className="w-full h-64 rounded-2xl overflow-hidden border border-gray-200 grayscale">
                  <iframe
              ...
              {/* Contact Form */}
              <div className="bg-gray-50 p-8 md:p-12 rounded-3xl border border-gray-200 shadow-2xl relative overflow-hidden group">
                ...
                <form className="space-y-6 relative z-10">
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input placeholder="John" className="bg-white border-gray-200 focus:border-mask h-14" />
                    </div>
                    <div className="space-y-2">
                      <label className="text-xs uppercase tracking-[0.2em] font-bold text-gray-500 ml-1">Last Name</label>
                      <Input placeholder="Doe" className="bg-white border-gray-200 focus:border-mask h-14" />
                    </div>
                  </div>

                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-[0.2em] font-bold text-gray-500 ml-1">Email Address</label>
                    <Input type="email" placeholder="john@example.com" className="bg-white border-gray-200 focus:border-mask h-14" />
                  </div>

                  <div className="space-y-2">
                    <label className="text-xs uppercase tracking-[0.2em] font-bold text-gray-500 ml-1">Message</label>
                    <Textarea placeholder="Ask us anything..." className="bg-white border-gray-200 focus:border-mask min-h-[150px] resize-none" />
                  </div>

                  <Button className="w-full bg-mask text-black font-bold h-14 text-sm uppercase tracking-widest hover:brightness-125 transition-all shadow-[0_0_20px_rgba(0,0,0,0.05)]">
                    Send Message
                  </Button>
                </form>
              </div>
