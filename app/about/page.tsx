          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
              <div className="space-y-6 text-gray-700 leading-relaxed text-lg">
                <p>
                  <span className="text-black font-bold">Panoramic Hotel</span> is a luxury hospitality destination designed to offer comfort, elegance, and unforgettable panoramic views. Our mission is to provide guests with a relaxing, secure, and premium stay experience at an affordable price.
                </p>
                <p>
              ...
              <div className="relative aspect-square rounded-2xl overflow-hidden border border-gray-200 shadow-2xl">
                <Image
                  src="/about.jpg"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-gray-200">
              <div className="p-8 bg-gray-50 rounded-xl border border-gray-200 space-y-4">
                <h3 className="text-xl font-bold text-mask uppercase tracking-widest">Our Vision</h3>
                <p className="text-gray-600 text-sm">To be the leading luxury hotel in Lahore, known for our breathtaking views and unmatched hospitality.</p>
              </div>
              <div className="p-8 bg-gray-50 rounded-xl border border-gray-200 space-y-4">
                <h3 className="text-xl font-bold text-mask uppercase tracking-widest">Our Mission</h3>
                <p className="text-gray-600 text-sm">Providing premium stays at affordable prices without compromising on quality or security.</p>
              </div>
              <div className="p-8 bg-gray-50 rounded-xl border border-gray-200 space-y-4">
                <h3 className="text-xl font-bold text-mask uppercase tracking-widest">Our Value</h3>
                <p className="text-gray-600 text-sm">Every guest is treated with care and professionalism to ensure a memorable stay.</p>
              </div>
            </div>
          </div>
        </div>
